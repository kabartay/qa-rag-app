...
# Complete Working RAG Application
...
class SimpleRAG:
    ...
    def answer_question(self, question: str) -> Dict:
        ...
        prompt = f"""You are an expert assistant helping users understand a technical document about municipal building requirements in Lyon, France.
    ...
    if st.button("Load Document", type="primary"):
        if not api_key:
            ...
            if document_text:
                ...
                st.error("⚠️ Please provide a document (upload PDF or paste text).")
